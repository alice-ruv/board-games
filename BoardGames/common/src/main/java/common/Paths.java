...
public class Paths
{
    ...
    public static final String APP_NAME = "/BoardGamesServer-v1";
    public static final String LOCALHOST_SERVER = "localhost"; //default server name
    ...
    //ports
    public static final String REST_SERVER_PORT = ":8080";
}
