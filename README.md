...
===========================================
Board game implementation for Battleship and Connect 4 in Java. Designated for two remote players with game results tracking.
Server side: RESTful server using Glassfish, getting REST API requests, sending messages to clients by JMS and connection to PostgreSQL DB by using JDBC.
Client side includes sending REST API requests, getting JMS messages and UI by using JavaFX.
