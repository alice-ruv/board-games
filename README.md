...
Server side: RESTful server using Glassfish, getting REST API requests, sending messages to clients by JMS and connection to PostgreSQL DB by using JDBC.<br />
